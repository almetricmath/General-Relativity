...
rec = mathDB.createProcessLoop(pFc, '(polar, cartesian) = ', 'Output.txt') 
...
rec = mathDB.createProcessLoop(pSqrtFp, '(polarSqrt, polar) = ', 'Output.txt')
...
rec = mathDB.createProcessLoop(p1Fp, '(polar1, polar) = ', 'Output.txt') 
...
rec = mathDB.createProcessLoop(pSqrt1Fp, '(polarSqrt1, polar) = ', 'Output.txt') 
